package nivell3.jobs.view;

import nivell3.jobs.application.JobsController;
...
public class Main {
	...
	public static void main(String[] args) throws Exception {
		...
		controller.createVolunteer("Juanita Volunteer", "Dirección molona 4", "614266666", "No cobra!", true);
		controller.createVolunteer("Juanito Volunteer", "Dirección molona 4", "614266666", "No cobra!", false);
