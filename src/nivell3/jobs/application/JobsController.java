...
import nivell3.jobs.domain.*;
import nivell3.jobs.persistence.EmployeeRepository;
...
public class JobsController {
	...
	public void createVolunteer(String name, String address, String phone, String descripcio, boolean ajutGovernamental) throws Exception{
		if (!descripcio.equals("No cobra!")) throw new Exception();
		Volunteer volunteer = new Volunteer(name, address, phone,  descripcio, ajutGovernamental);
